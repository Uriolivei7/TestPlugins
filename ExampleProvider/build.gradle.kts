...
cloudstream {
    ...
    /**
     * Status int como uno de los siguiente:
     * 0: Caído
     * 1: Ok
     * 2: Lento
     * 3: Solo Beta
...
dependencies {
    // AÑADIDAS: Dependencias necesarias para BlankFragment.kt
...
// No necesitas una tarea 'clean' aquí, ya que está definida en el build.gradle.kts de la raíz.
